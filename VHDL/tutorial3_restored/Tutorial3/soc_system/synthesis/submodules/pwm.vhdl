...
ARCHITECTURE logic OF pwm IS
  ...
  SIGNAL  input_signed :  signed(31 downto 0) := (others => '0');
  SIGNAL  input_magnitude : signed(31 downto 0) := (others => '0');
BEGIN
  ...
  BEGIN
	...
	ELSIF(avalon_slave_write_n = '0') THEN
		input_signed <= signed(avalon_slave_writedata(31 downto 0));
